...
See [the elevation manifest](assets/hydraulic-connectivity-2022-2014-v2/SourceResamplingManifest.json) for tile URLs, survey dates, checksums, units, coverage, and processing, and [the rebuild instructions](tools/highlands_lidar/README.md) for reproduction and validation.
